#Datasource
data "aws_ec2_instance_type_offerings" "my_instype_2" {
...
output "output_v2_1" {
  ...
  value = toset([for t in data.aws_ec2_instance_type_offerings.my_instype_2: t.instance_types])
}
...
output "output_v2_2" {
  value = {
    for az,details in data.aws_ec2_instance_type_offerings.my_instype_2: az => details.instance_types
  }
}